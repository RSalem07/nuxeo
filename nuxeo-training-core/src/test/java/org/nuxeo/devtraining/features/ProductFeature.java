...
package org.nuxeo.devtraining.features;
...
/**
 * The type Product feature.
 *
 * @since 10.10
 */
@Features({ CoreFeature.class, CollectionFeature.class })
@Deploy("org.nuxeo.devtraining.nuxeo-training-core")
@Deploy("studio.extensions.saouana-SANDBOX")
